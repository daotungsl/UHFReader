...
//#if _DEBUG
                if ((antStatus & (1 << 0)) != 0)
                {
                    ...
                    Image img = new Bitmap(Properties.Resources.Single);
                    ANT1_pictureBox.Image = img;
                }
                else
                {
                    Image img = new Bitmap(Properties.Resources.NoSingle);
                    ANT1_pictureBox.Image = img;
                }
                if ((antStatus & (1 << 1)) != 0)
                {
...
//#endif
        ...
        private void EPC_START_button_Click(object sender, EventArgs e)
        {
            ...
            if (rbtnShowView.Checked)
            {
                ...
                viewShow.ShowDialog();
                if (viewShow.DialogResult == DialogResult.Abort)
                {
                    EPC_STOP_button_Click(null, null);
                }
            }
        ...
        void EPCMultiTagInventory()
        {
            ...
            if (0x00 == status) // if inventory success
            {
